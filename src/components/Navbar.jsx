    ...
    <nav className="bg-none text-white fixed w-full z-20 top-0 start-0 px-1  sm:px-6 py-4">
      <div className="flex flex-wrap items-center justify-between">
        <div className="flex items-center">
          <a href="/" className="text-4xl font-bold mr-4">
            Wefo
          </a>
        ...
        <div className="flex items-center">
          ...
          <button type="button" className="hidden md:block bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-full text-sm px-5 py-2.5 text-center ml-4">
            Start project
          </button>
        </div>
      </div>
